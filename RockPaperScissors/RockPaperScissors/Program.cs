...
namespace RockPaperScissors
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            int hrac = Convert.ToInt32(0);
            int pocitac = Convert.ToInt32(0);
            Console.WriteLine("Zadej délku hry (vítězné skóre)");
            int delka = Convert.ToInt32(Console.ReadLine());
            for (int i = 0; i < delka; i++) 
            { 
                
                Console.WriteLine("Zvol si kamen, nuzky nebo papir");
